package de.beckdev.quickfix.generator;/*
...
public class CodeGeneratorJ {
  ...
  private static final String FIELD_PACKAGE = "de.beckdev.quickfix.field";
  ...
  /**
   * Runs a de.beckdev.quickfix.generator.CodeGeneratorJ with command line arguments
   *
